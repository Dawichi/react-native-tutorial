...
Here a little showcase of the functionality using react-native-maps, showing a marker with our current location
...
Is an Expo package to use the camera of the device
...
Here a little showcase of the functionality, showing the camera on the screen and allowing to change between front and back cameras
