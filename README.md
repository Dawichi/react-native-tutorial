...
Is an Expo package to read geolocation from the device. Here a little showcase of the functionality using react-native-maps, showing a marker with our current location
